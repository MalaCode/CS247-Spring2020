...
if not use_twitter:
    ...
    features = ["AvgSentiment", "AvgTopicContrib", "Negative", "Positive", "Neutral"]
    target = "testPositive"
...
randomize_time_series_data = False
...
plt.legend()
plt.suptitle('LSTM - Tested Positve')
plt.savefig("baselines/lstm.png")
